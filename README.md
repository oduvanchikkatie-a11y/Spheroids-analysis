...
**"Small spheroid"**: маленький сфероид значительно отличается по размерам от обычного, поэтому был выделен в отдельный класс.
...
### Описание свойств
_Примечание 1:_ во всех свойствах учтён масштаб изображений (2.2 мкм/пиксель), что соответствует увеличению 4х на микроскопе. 

_Примечание 2:_ **выпуклая оболочка** — это множество пикселей, входящих в состав наименьшего выпуклого многоугольника, окружающего все белые пиксели во входном изображении.
<p align="center">
  <img src="img.png" alt="Выпуклая оболочка" width="300">
    <figcaption align="center">Рис.1 Выпуклая оболочка</figcaption>
</p>
...
| **Aspect_ratio**                  | Соотношение сторон — отношение ширины к высоте ограничивающего объект прямоугольника                                                                                                                                                                                                                                                                                                                                                              |
| **Extent**                        | Прямоугольность — отношение площади объекта к площади его ограничивающего прямоугольника. <br/> **Физ. смысл:** показывает, какая часть bbox заполнена объектом. <br/>**Диапазон значений (0, 1]:** ближе к 0 - объект заполняет bbox нерегулярно<br/> ближе к 1 - объект имеет прямоугольную форму без дыр.                                                                                                                                      |
...
| **Minor_axis_length**             | Длина малой оси — длина малой оси эллипса, имеющего те же моменты, что и объект.<br/>1) Малая примерно равна большой - объект больше похож на круг<br/>2) Малая сильно меньше большой - объект имеет удлинение                                                                                                                                                                                                                                    |
| **Eccentricity**                  | Эксцентриситет — мера вытянутости объекта. <br/>**Диапазон значений [0, 1]:** <br/> 0 - круг <br/>1 - линия                                                                                                                                                                                                                                                                                                                                       |
| **Circularity**                   | Круглость — степень сходства с кругом. Показатель как формы, так и шероховатости.<br/>**Диапазон значений(0, 1]:** 1 - круг<br/><1 - есть вогнутости<br/>стремится к 0 - объект бесконечно вытянут, периметр объекта растет значительно быстрее площади. <br/>**Формула:** 4π×площадь/периметр²                                                                                                                                                   |
| **Solidity**                      | Сплошность — мера вогнутости/изрезанности. <br/>**Диапазон значений (0, 1]**: 1 - выпуклый объект без дыр(круг, эллипс, многоугольник) <br/><1 - объект с впадинами, дырами. <br/>**Формула:** площадь/площадь_выпуклой_оболочки                                                                                                                                                                                                                  |
| **Convexity**                     | Выпуклость — гладкость границы. <br/>**Диапазон значений (0, 1]:** 1 - выпуклый объект <br/><1 при наличии вогнутостей.<br/>**Формула:** периметр_выпуклой_оболочки/периметр                                                                                                                                                                                                                                                                      |
| **Roundness**                     | Округлость — мера схожести объекта с кругом без учета деталей границы.<br/>Диапазон значений (0, 1]: <br/>1 - идеальный круг <br/>близко к нулю при удлиненной/звездовидной форме.<br/> В отличие от круглости не зависит от неровностей границы<br/>**Формула:** 4 × area/(π × major_axis_length²)                                                                                                                                               |
| **Compactness**                   | Компактность — сложность формы.<br/>**Диапазон значений (0,1]:** 1 - круг<br/> <1 - все остальные формы. Чем выше значение, тем сложнее/изрезаннее форма. <br/>(4π × площадь)/периметр²                                                                                                                                                                                                                                                              |
| **Feret_max**                     | Максимальный диаметр Фере — максимальное расстояние между параллельными касательными к контуру объекта                                                                                                                                                                                                                                                                                                                                               |
| **Feret_min**                     | Минимальный диаметр Фере — минимальное расстояние между параллельными касательными к контуру объекта                                                                                                                                                                                                                                                                                                                                                 |
| **Num_vertices**                  | Количество вершин — число вершин в полигональной аппроксимации контура                                                                                                                                                                                                                                                                                                                                                                               |
| **Logarithmic_hu_moment_1-7**     | **Первый момент Ху** — инвариант к повороту, масштабу и переносу. **Физический смысл:** характеризует распределение массы относительно центра, аналогично моменту инерции.<br/> **Второй** — инвариант к повороту, масштабу и переносу. **Физический смысл:** характеризует асимметрию и вытянутость.<br/> **Третий** — инвариантная характеристика формы. Чувствителен к зеркальной симметрии.<br/> **Четвертый - седьмой** — инвариантные характеристики формы. 
